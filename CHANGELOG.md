...
* Added rsyslog startup Execute rsyslogd to start up system logging [Robbe Haesendonck]
* Added logentries Installed rsyslog and added back logentries. [Robbe Haesendonck]
* Added redis startup script Made redis start up also if the environment variables match [Robbe Haesendonck]
* Removed systemd Removed systemd from registry container. [Robbe Haesendonck]
